...
<html>
<head>
	<title>| Sistema Admin MIRANDA COTO |</title>
...
BODY {
  ...
  <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
    ...
    <tr>
      <td width="200" rowspan="2" align="left" valign="top" bgcolor="#"> <uc1:UCNavigation id="UserControl1" runat="server"></uc1:UCNavigation></td>
...
<tr>
                ...
                <td width="490" height="65" align="left" valign="bottom" class="title2"><ASP:Label id="lblTitle" runat="server" ForeColor="#CC3300">LOGIN</ASP:Label></td>
                        ...
                        <tr>
                          ...
                          <td height="20" colspan="2" align="right"  valign="middle">
                              <ASP:Button CssClass="boton_formulario" id="btnLogin" runat="server" 
                                  text="LOGIN" width="86px" onclick="btnLogin_Click" ForeColor="#CC00CC"></ASP:Button></td>
                        </tr>
                      </table>
