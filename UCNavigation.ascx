...
<table width="200" border="0" cellspacing="1" cellpadding="0" style ="background-color:purple">
    <tr>
    ...
    <tr id="divLogin" runat="server">
      ...
      <td height="20" bgcolor="#00cc99"><asp:HyperLink CssClass="izq" ID="lnkCRM" NavigateUrl="Login.aspx" runat="server">CRM Login</asp:HyperLink></td>
      <td height="20">&nbsp;</td>
    </tr>
    ...
    <tr id="divlnkHome">
      <td height="20">&nbsp;</td>
      <td bgcolor="#CC0000">&nbsp;</td>
      <td height="20" bgcolor="#00CC99"><ASP:HyperLink CssClass="izq" id="lnkHome"
				 navigateurl="Main.aspx" runat="server">Home</ASP:HyperLink></td>
      <td height="20">&nbsp;</td>
    </tr>
    <tr id="divlblVentas" >
      <td height="20" style="HEIGHT: 21px">&nbsp;</td>
      <td width="4" bgcolor="#CC0000" style="HEIGHT: 21px">&nbsp;</td>
      <td height="20" bgcolor="#00CC99" class="titleBlak" style="HEIGHT: 21px">
    ...
    <tr id="divlnkAddVenta" >
      ...
      <td height="20" bgcolor="#00CC99">&nbsp;&nbsp;&nbsp;&nbsp;<ASP:HyperLink id="lnkAddVenta" runat="server" cssclass="izq2" navigateurl="AddVenta.aspx">Nueva Venta</ASP:HyperLink></td>
      <td height="20">&nbsp;</td>
    </tr>
    <tr id="divlnkListVentas" >
      <td height="20">&nbsp;</td>
      <td width="4" bgcolor="CC0000">&nbsp;</td>
      <td height="20" bgcolor="#00CC99">&nbsp;&nbsp;&nbsp;&nbsp;<ASP:HyperLink
    ...
    <tr id="divlblProductos" >
      <td height="20">&nbsp;</td>
      <td width="4" bgcolor="#CC0000">&nbsp;</td>
      <td height="20" bgcolor="#00CC99" class="titleBlanco">
    ...
    <tr id="divlnkChangePassword" >
      <td height="20">&nbsp;</td>
      <td width="4" bgcolor="#CC0000">&nbsp;</td>
      <td height="20" bgcolor="#00CC99" classname="izq"><ASP:HyperLink id="lnkChangePassword" class="izq"
    ...
    <tr id="divlnkLogout" >
      ...
      <td width="4" bgcolor="#CC0000" style="HEIGHT: 20px">&nbsp;</td>
      <td height="20" bgcolor="#00CC99" style="HEIGHT: 20px">
        <p>
          <ASP:HyperLink id="lnkLogout" runat="server" cssclass="izq2" navigateurl="LogOut.aspx">Log Out</ASP:HyperLink>
        </p></td>
      <td width="10" height="20" style="HEIGHT: 20px">&nbsp;</td>
    </tr>
    <tr style="background:purple" runat="server" id="trTipoSitio" visible="false">
      <td width="10">&nbsp;</td>
      <td width="4">&nbsp;</td>
      <td>TESTING...</td>
      <td width="10">&nbsp;</td>
